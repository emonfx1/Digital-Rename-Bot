...
Tʜɪs Bᴏᴛ Wᴀs Cʀᴇᴀᴛᴇᴅ Bʏ : @Ordinary_Bots 💞</b>"""

    ABOUT_TXT = """<b>╭───────────⍟
├🤖 ᴍy ɴᴀᴍᴇ : {}
├🖥️ Dᴇᴠᴇʟᴏᴩᴇʀꜱ : <a href=https://t.me/Ordinary_Bots>ORDINARY_BOTS</a> 
├👨‍💻 Pʀᴏɢʀᴀᴍᴇʀ : <a href=https://t.me/XBot_Creator>XBot_Creator</a>
├📕 Lɪʙʀᴀʀy : <a href=https://github.com/pyrogram>Pyʀᴏɢʀᴀᴍ</a>
├✏️ Lᴀɴɢᴜᴀɢᴇ: <a href=https://www.python.org>Pyᴛʜᴏɴ 3</a>
├💾 Dᴀᴛᴀ Bᴀꜱᴇ: <a href=https://cloud.mongodb.com>Mᴏɴɢᴏ DB</a>
├📊 ᴠᴇʀsɪᴏɴ: <a href=https://t.me/emonfx7>3.𝟶.𝟶</a></b>     
╰───────────────⍟ """
...
ℹ️ 𝗔𝗻𝘆 𝗢𝘁𝗵𝗲𝗿 𝗛𝗲𝗹𝗽 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 :- <a href=https://t.me/XBot_Creator>𝑺𝑼𝑷𝑷𝑶𝑹𝑻</a>
"""
...
•⪼ 🥇𝘎𝘰𝘭𝘥    - 15𝘥𝘢𝘺𝘴 -  40
•⪼ 🏆𝘗𝘭𝘢𝘵𝘪𝘯𝘶𝘮 - 1𝘮𝘰𝘯𝘵𝘩 -  60
•⪼ 💎𝘋𝘪𝘢𝘮𝘰𝘯𝘥 - Permanent -  120

- 𝘋𝘢𝘪𝘭𝘺 𝘜𝘱𝘭𝘰𝘢𝘥 𝘓𝘪𝘮𝘪𝘵 𝘜𝘯𝘭𝘪𝘮𝘪𝘵𝘦𝘥
- 𝘋𝘪𝘴𝘤𝘰𝘶𝘯𝘵 𝘈𝘭𝘭 𝘗𝘭𝘢𝘯 BDT.9
    """
    THUMBNAIL = """
...
◦ <code> -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @Ordinary_Bots" -metadata author="@XBot_Creator" -metadata:s:s title="Subtitled By :- @ordinary_bots" -metadata:s:a title="By :- @XBot_Creator" -metadata:s:v title="By:- @XBot_Creator" </code>

📥 Fᴏʀ Hᴇʟᴘ Cᴏɴᴛ. @ordinary_bots
"""
...
Exᴀᴍᴩʟᴇ:- `/set_suffix @Ordinary_Bots`
Exᴀᴍᴩʟᴇ:- `/set_prefix @Ordinary_Bots`
"""
...
» 𝗦𝗢𝗨𝗥𝗖𝗘 𝗖𝗢𝗗𝗘 : <a href=https://t.me/Ordinary_Bots>ORDINARY_BOTS</a>

• ❣️ <a href=https://github.com/Emonfx1>EMON FX</a>
• ❣️ <a href=https://github.com/Ordinary_Bots>ORDINARY BOTS</a>
• ❣️ <a href=https://github.com/XBot_Creator>XBot_Creator</a> """
...
◦ <code> -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @Ordinary_Bots" -metadata author="@XBot_Creator" -metadata:s:s title="Subtitled By :- @Ordinary_Bots" -metadata:s:a title="By :- @Ordinary_Bots" -metadata:s:v title="By:- @XBot_Creator" </code>

📥 Fᴏʀ Hᴇʟᴘ Cᴏɴᴛ. @Ordinary_Bots
"""
    
    RKN_PROGRESS = """<b>\n
╭━━━━❰ORDINARY_BOTS PROCESSING...❱━➣
┣⪼ 🗃️ ꜱɪᴢᴇ: {1} | {2}
┣⪼ ⏳️ ᴅᴏɴᴇ : {0}%
┣⪼ 🚀 ꜱᴩᴇᴇᴅ: {3}/s
┣⪼ ⏰️ ᴇᴛᴀ: {4}
